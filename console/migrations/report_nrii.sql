...
-- -----------------------------------------------------
-- Table `reportnrii`.`rnrii_account_group`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `reportnrii`.`rnrii_account_group` (
...
-- -----------------------------------------------------
-- Table `reportnrii`.`rnrii_account`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `reportnrii`.`rnrii_account` (
  `account` VARCHAR(32) NOT NULL COMMENT 'ReportRNII平台的账户',
  `auth_key` VARCHAR(32) NULL,
  `password_hash` VARCHAR(255) NULL COMMENT 'ReportNRII平台的登录密码，使用Hash加密处理，32位',
  `password_reset_token` VARCHAR(255) NULL,
  `pf_name` VARCHAR(45) NOT NULL,
  `pf_desc` TEXT(500) NULL,
  ...
  `db_charset` VARCHAR(45) NULL COMMENT '数据库连接参数，例：useUnicode=true&characterEncoding=gbk',
  ...
  CONSTRAINT `fk_rnrii_accound_rnrii_accound_group`
    FOREIGN KEY (`group`)
    REFERENCES `reportnrii`.`rnrii_account_group` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `reportnrii`.`rnrii_instrument_config` (
  ...
  INDEX `fk_rnrii_instrument_config_rnrii_accound1_idx` (`account` ASC),
  CONSTRAINT `fk_rnrii_instrument_config_rnrii_accound1`
    FOREIGN KEY (`account`)
    REFERENCES `reportnrii`.`rnrii_account` (`account`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `reportnrii`.`rnrii_remote_field` (
  ...
  CONSTRAINT `fk_rnrii_field_map_rnrii_instrument_config1`
    ...
    REFERENCES `reportnrii`.`rnrii_instrument_config` (`type` , `account`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `reportnrii`.`rnrii_instrument` (
  ...
  `instrument` TINYINT(1) NOT NULL COMMENT '填报数据类型\n1代表科学仪器中心\n2代表大型科学装置\n3代表科学仪器服务单元\n4代表单台套科学仪器设备\n5代表海关监管信息\n6代表服务记录',
  `cname` VARCHAR(50) NULL COMMENT '仪器中心名称	科学仪器中心全称，不可简写（最多50字）',
  ...
  `url` VARCHAR(100) NULL COMMENT '装置网站的网址	提供科学装置所在网站的URL',
  ...
  `shareMode` VARCHAR(10) NULL COMMENT '共享模式	内部共享、外部共享、不共享',
  ...
  `created_at` INT(11) NULL,
  `updated_at` INT(11) NULL,
  PRIMARY KEY (`account`, `innerId`),
  INDEX `fk_rnrii_instrument_rnrii_account1_idx` (`account` ASC),
  CONSTRAINT `fk_rnrii_instrument_rnrii_account1`
    FOREIGN KEY (`account`)
    REFERENCES `reportnrii`.`rnrii_account` (`account`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `reportnrii`.`rnrii_customs_supervision` (
  ...
  `updated_at` INT(11) NULL,
  PRIMARY KEY (`account`, `innerId`),
  INDEX `fk_rnrii_customs_supervision_rnrii_account1_idx` (`account` ASC),
  CONSTRAINT `fk_rnrii_customs_supervision_rnrii_account1`
    FOREIGN KEY (`account`)
    REFERENCES `reportnrii`.`rnrii_account` (`account`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `reportnrii`.`rnrii_service_record` (
  ...
  `result` INT NULL,
  PRIMARY KEY (`account`, `innerId`),
  INDEX `fk_rnrii_service_record_rnrii_account1_idx` (`account` ASC),
  CONSTRAINT `fk_rnrii_service_record_rnrii_account1`
    FOREIGN KEY (`account`)
    REFERENCES `reportnrii`.`rnrii_account` (`account`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `reportnrii`.`rnrii_service_effect`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `reportnrii`.`rnrii_service_effect` (
  `account` VARCHAR(32) NOT NULL,
  ...
  `updated_at` INT(11) NULL,
  `result` INT NULL,
  INDEX `fk_rnrii_inscode_rnrii_account1_idx` (`account` ASC),
  PRIMARY KEY (`account`),
  CONSTRAINT `fk_rnrii_inscode_rnrii_account1`
    FOREIGN KEY (`account`)
    REFERENCES `reportnrii`.`rnrii_account` (`account`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
