...
/**
 * This is the model class for table "{{%inscode}}".
 *
 ...
 */
class InsCode extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['insCode', 'client_id', 'client_secret', 'redirect_uri', 'submittedRates', 'activatedRates', 'totalShareRates', 'externalShareRates', 'Innovation', 'serviceAmounts', 'user', 'serviceIncome'], 'string', 'max' => 45],
    ...
    {
        return $this->hasMany(Account::className(), ['insCode' => 'insCode']);
    }
    ...
    {
        return $this->hasMany(CustomsSupervision::className(), ['insCode' => 'insCode']);
    }
    ...
    {
        return $this->hasMany(Instrument::className(), ['insCode' => 'insCode']);
    }
    ...
    {
        return $this->hasMany(ServiceRecord::className(), ['insCode' => 'insCode']);
    }
}
