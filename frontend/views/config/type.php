                            ...
                            <div class="box box-primary">
                                ...
                                <form role="form">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            <label for="dbname"><?= Yii::t('yii', 'SQL Field LIST') ?>[:fields]</label>
                                                        ...
                                                        case 'EMAIL':
                                                            ...
                                                            <div class="form-group">
                                                                <input type="email" class="form-control"
                                                                       name="<?= $field ?>" placeholder="Enter email">
                                                            </div>
                                                            <?php
                                                            break;
                                                        case 'PHONE':
                                                            ?>
                                                            <div class="form-group">
                                                                <label><?= isset($opt['label']) ? $opt['label'] : $field ?></label>
                                                                <input type="text" name="<?= $field ?>"
                                                                       class="form-control"/>
                                                            </div>
                                                            <?php
                                                            ...
                                                            <div class="form-group">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                           data-inputmask="'alias': '<?= $opt['format'] ?>'"
                                                                           data-mask/>
                                                                </div><!-- /.input group -->
                                                            </div><!-- /.form group -->
                                                            <?php
